...
1. Abrir `index.html` en el navegador para visualización continua
2. Usar Ctrl+P para exportar a PDF
3. El documento es autocontenido (CSS y JS embebidos)
...
- No se inventan normas, artículos, decretos ni órdenes
- No se inventan porcentajes de calificación ni asistencia
- No se inventan datos del centro, alumnado o profesorado
- No se inventan repertorios ni fechas de conciertos
- Cuando un elemento no puede acreditarse, permanece en HOLD
